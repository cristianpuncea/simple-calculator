class Calculator {
    ...
    chooseOperation(operation) {
      ...
      if (operation.includes("addition")) {this.operation = "+"};
      if (operation.includes("subtraction")) {this.operation = "-"};
      if (operation.includes("multiplication")) {this.operation = "*"};
      if (operation.includes("division")) {this.operation = "/"};
  ...
  operationButtons.forEach(button => {
    button.addEventListener('click', (event) => {
      calculator.chooseOperation(event.target.classList.value);
      calculator.updateDisplay();
    })
  })
